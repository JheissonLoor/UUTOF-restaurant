...
export default {
  ...
  theme: {
    extend: {
      ...
      borderRadius: { sm: '10px', md: '14px', lg: '18px', xl: '22px', '2xl': '26px' },
      boxShadow: {
        soft: '0 1px 2px rgba(31,26,20,0.04), 0 14px 30px -16px rgba(31,26,20,0.22)',
        toast: '0 16px 40px -12px rgba(31,26,20,0.5)',
      },
    },
  },
  plugins: [forms],
